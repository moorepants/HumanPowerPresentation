...
% Use the following line to explicitly define the date.
%\date{October 9, 2009}
\begin{document}
\frame{\titlepage}
...
\frame
{
  ...
  \begin{center}
    ...
    \includegraphics[width=4cm]<2>{images/energy-use-of-vehicle-type.jpg}
    \includegraphics[width=7cm]<3>{images/tires.png}
  \onslide<3->
  \\
