...
\frame
{
    ...
    \begin{itemize}
        ...
        \item<3-> But we are about as efficient as an ICE (35\%)
    \end{itemize}
    \onslide<3->
    \begin{center}
        \includegraphics[width=3cm]{HumanMuscles.png}
        \Large{$=$}
        \includegraphics[width=3cm]{internal-combustion-engine.jpg}
    \end{center}
}
\note{We convert energy from one form to another and just like all energy
transformation processes, some (or a lot!) of the energy is lost in the
conversion process. So how do we maximize the efficiency of the work we do?}
\frame
{
...
\frame
{
    ...
    \begin{itemize}[<+->]
        \item Pedaling and rowing are the two known most efficient means of human
            power
        \item There are optimum pedal and rowing rates for efficient power output
...
\frame
{
    ...
    \begin{center}
        \includegraphics[width=4cm]<1>{BeijingBicycles.jpg}
        \includegraphics[width=7cm]<2>{tires.png}
    \onslide<2->
...
\frame
{
    \frametitle{Drill example}
        ...
        \end{itemize}
        \begin{center}
            \includegraphics[width=4cm]{power-drill.jpg}
            \includegraphics[width=4cm]{hand-drill.jpg}
        \end{center}
}
\frame
{
