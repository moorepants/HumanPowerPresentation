...
\note{So now that we are refreshed about work and power, I'd like to show you
...
\frame
{
	...
	\begin{beamerboxesrounded}[upper=uppercol,lower=lowercol,shadow=true]{Efficiency}
        \begin{center}
					$\cdot efficiency= \frac{output}{input}$
        \end{center}
    \end{beamerboxesrounded}
    \onslide<4->
    \begin{itemize}
...
\frame
{
	...
	\begin{center}
		\begin{columns}[t]
			...
			\column{5cm}
			\includegraphics[width=5cm]{images/motor-power-vs-rpm.png}
		\end{columns}
		\begin{center}
			\includegraphics[width=4.5cm]{images/motor-efficiency-vs-rpm.png}
		\end{center}
	\end{center}
}
...
take all of this and more into account. Motor graphs
from: http://www.recumbents.com/mars/pages/proj/sadler/assist/projsadassist.html}
%
